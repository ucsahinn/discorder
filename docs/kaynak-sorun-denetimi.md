...
| Discord dışı `Update.exe` kapsamı | Discord klasörleri, bilinen Discord exe adları ve desteklenen tarayıcı adları kullanılır | Genel güncelleyici veya üçüncü taraf güncelleyici tünellenmez |
| Eski/şüpheli kurucu paketleri | WireSock resmi kurucusu çalışma zamanında doğrulanır | Repoya kurucu gömülmez |
| Profil bozulması veya geniş `AllowedApps` | Profil yeniden yazılır ve testlerle kilitlenir | Discord uygulamaları ve desteklenen tarayıcılar kalır |
...
| Discord mesaj, profil, güncelleme, başlangıç, çökme veya giriş sorunları | `#168`, `#154`, `#152`, `#143`, `#140`, `#135`, `#86`, `#68` | Ürün Discord Stable, PTB, Canary, Development ve desteklenen tarayıcı süreçlerini WARP profiline alır. Profil her çalıştırmada dar kapsamla yeniden üretilir. |
| Tarayıcıdan Discord web, otomatik sayfa veya tarayıcı tüneli davranışı | `#167`, `#127`, `#121`, `#97`, `#94` | Tarayıcı desteği artık açık ürün kararıdır. Desteklenen tarayıcı süreçleri tünellenir; kapatınca WireSock süreci sonlandırılır ve kalıcı tarayıcı/DNS/firewall kuralı bırakılmaz. |
