...
| --- | --- | --- |
| Tarayıcıdan Discord web'e erişilememesi | Chrome, Edge, Firefox, Brave, Opera ve Vivaldi süreçleri isteğe bağlı kapsama alındı | Discord web modu açıldığında Discord uygulaması ve desteklenen tarayıcılar birlikte tünellenir; kapalıyken desteklenen tarayıcılar için geçici Discord web engeli uygulanır |
...
| Tarayıcıdan Discord web, otomatik sayfa veya tarayıcı tüneli davranışı | `#167`, `#127`, `#121`, `#97`, `#94` | Tarayıcı desteği opsiyonel ürün kararıdır ve varsayılan kapalıdır. Web modu açıldığında Discord uygulaması ve desteklenen tarayıcı süreçleri birlikte tünellenir. Web modu kapalı bağlı oturumda desteklenen tarayıcıların Discord'a düz internetten çıkmasını azaltan geçici firewall kapsamı uygulanır; bağlantı kapanınca bu geçici kapsam temizlenir ve Discorder'a ait Discord alan adı kilidi yeniden açılır. |
